		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample from Instructor",
									"targetURL": "#samplefrominstructorsamplefrominstructor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"samplefrominstructorsamplefrominstructor-display": {
								"semanticObject": "samplefrominstructorsamplefrominstructor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=samplefrominstructor.samplefrominstructor",
									"url": sap.ui.require.toUrl("samplefrominstructor/samplefrominstructor")
								}
							}
						}
					}
