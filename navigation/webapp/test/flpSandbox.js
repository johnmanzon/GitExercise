		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#Navigationnavigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Navigationnavigation-display": {
								"semanticObject": "Navigationnavigation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Navigation.navigation",
									"url": sap.ui.require.toUrl("Navigation/navigation")
								}
							}
						}
					}
