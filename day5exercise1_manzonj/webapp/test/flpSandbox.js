		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1manzonj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1manzonj-display": {
								"semanticObject": "zbtpday5exercise1manzonj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1manzonj",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1manzonj")
								}
							}
						}
					}
